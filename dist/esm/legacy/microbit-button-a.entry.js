...
var MicrobitButtonA = /** @class */ (function () {
    function MicrobitButtonA(hostRef) {
    ...
    MicrobitButtonA.prototype.servicesUpdated = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, service.addEventListener("buttonastatechanged", function (event) { return _this.setClassName(event.detail); })];
                    case 1:
                        _b.sent();
                        _a = this.setClassName;
                        return [4 /*yield*/, service.readButtonAState()];
                    case 2:
    ...
    MicrobitButtonA.prototype.setClassName = function (state) {
        this.className = state === 1 ? this.shortPressClass
            : state === 2 ? this.longPressClass
                : this.releaseClass;
    };
    MicrobitButtonA.prototype.render = function () {
        return (h("span", { class: this.className }, h("slot", null)));
    };
    Object.defineProperty(MicrobitButtonA.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MicrobitButtonA, "watchers", {
        get: function () {
            return {
