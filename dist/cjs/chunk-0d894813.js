...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('chunk-0d894813.js', document.baseURI).href));
    if (importMeta !== '') {
...
const initializeComponent = async (elm, hostRef, cmpMeta, hmrVersionId, Cstr) => {
    ...
    const schedule = () => scheduleUpdate(elm, hostRef, cmpMeta);
    {
        schedule();
    }
};
